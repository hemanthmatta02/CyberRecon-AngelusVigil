                ...
                if (self._inference_engine is not None
                    ...
                    if per_model_scores is not None:
                        ...
                        final_score = blend_scores(
                            ...
                            # Rules must remain the dominant signal for this
                            # lab.  A noisy ML score alone should be visible
                            # as low/medium behavioural activity, not turn
                            # every normal manual request into HIGH.
                            ml_weight=0.35,
                        )
